<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.util.Random" %> <!-- Esto es una directiva y lo de arriba también --> 
<!DOCTYPE html>
<html>
<head>
...
<!--Declaración, lo que se declara aquí se mantiene para todas las sesiones (durante toda la sesion del servidor). No muestra nada-->
<%!
	int contador = 0;  
	String frase;
...
<H1>Scriptlets</H1>  <!-- Se ejecuta una vez por cada requerimiento, no muestra nada -->
	...
	<p> Acessos a la página: <%= contador %> </p>
